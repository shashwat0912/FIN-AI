...
This root owns the production state boundary, AWS provider, VPC, and EKS module
calls. The example uses `10.20.0.0/16`, two AZs, one NAT Gateway per AZ, and two
